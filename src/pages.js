...
async function saveClasses(req, res) {
  ...
  const { subject, cost, weekday } = req.body
...
function buildQueryString(queryData) {
  const { subject, weekday, time_from } = queryData
  return `?subject=${subject}&weekday=${weekday}&time=${time_from}`
}
